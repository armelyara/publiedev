...
import { Mail, Lock, Github, Code } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            ...
            <Link to="/register" className="text-bluesky-500 hover:text-bluesky-600">
              Créer un compte
            </Link>
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-gray-300 text-bluesky-500" />
                <span className="ml-2 text-gray-600">Se souvenir de moi</span>
              </label>
              <Link to="/forgot-password" className="text-bluesky-500 hover:text-bluesky-600">
                Mot de passe oublié?
              </Link>
            </div>
