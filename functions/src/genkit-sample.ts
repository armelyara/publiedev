...
// Gemini Developer API models and Vertex Express Mode models depend on
// an API key. API keys should be stored in Cloud Secret Manager so that
...
export const menuSuggestion = onCallGenkit({
  // Uncomment to enable AppCheck. This can reduce costs by ensuring only
  // your Verified app users can use your API.
  ...
  // (a uid and tokens dictionary) and the request data.
  // The isSignedIn() and hasClaim() helpers can be used to simplify.
  // The following will require the user to have the email_verified claim.
